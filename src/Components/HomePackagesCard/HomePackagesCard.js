...
const HomePackagesCard = (props) => {
  const {_id, name, price, city, country, description, img } =
  props.allPackage || {};
      ...
      <div className="card h-80 p-2 mb-5 text-start">
        ...
        <div className="card-body">
          <h5 className="card-title fw-normal">
            <span className="fw-bold">Package Name:</span> {name}
          </h5>
          <h6 className="card-text fw-normal">
            <span className="fw-bold">Package Price:</span> {price}
          </h6>
          <h6 className="card-text fw-normal">
            <FontAwesomeIcon icon={faCity} size="lg" /> <span className="fw-bold">City Special:</span> {city}
          </h6>
          <h6 className="card-text fw-normal"><FontAwesomeIcon icon={faGlobeAsia} size="lg" /> <span className="fw-bold">Continent:</span> {country}
          </h6>
          <h6 className="card-text fw-normal">
